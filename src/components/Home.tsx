...
export const Home: React.FC<HomeProps> = ({
  ...
  const socialLinks = [
    {
      icon: FaGithub,
      href: "https://github.com/HGiorgis",
      label: "GitHub",
      color: "hover:text-gray-400",
    },
    {
      icon: FaTelegram,
      href: "https://t.me/hgiorgis",
      label: "Telegram",
      color: "hover:text-blue-400",
    },
    {
      icon: FaEnvelope,
      href: "mailto:hailegiorgiswagaye@gmail.com",
      label: "Email",
      color: "hover:text-red-400",
    },
    {
      icon: FaLinkedin,
      href: "https://linkedin.com/in/hgiorgis23",
      label: "LinkedIn",
  ...
  const realms = [
    {
      ...
      description:
        "Full-stack development, system architecture, and cutting-edge web technologies",
      icon: Code,
      color: "blue",
      features: [
        "React/Next.js",
  ...
  const updatedRealms = realms.map((realm) => ({
    ...
    locked:
      realm.id === "design"
        ? !unlockedRealms.includes("design")
        : realm.id === "game"
        ? !unlockedRealms.includes("game")
        : realm.locked,
  }));
  ...
  const skills = [
    ...
    { name: "React", level: 85 },
    { name: "Security Techiniqes", level: 70 },
    { name: "Native code", level: 85 },
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div className="mb-8" variants={fadeInUpVariants}>
            ...
            >
              {[
                ...
                {
                  icon: Calendar,
                  text: `Graduation ${personalInfo.graduation}`,
                  color: "blue",
                },
              ].map((item, index) => (
                <motion.div
          ...
          <motion.p
            ...
            variants={fadeInUpVariants}
          >
            True development is crafting code that not only works
            <span className="text-cyan-400"> but </span>
            challenges; <span className="text-purple-400">
              true security
            </span>{" "}
            is designing systems that protect even the unknown.
          </motion.p>
          ...
          >
            {[
              ...
              >
                <div
                  className={`text-3xl text-${metric.color}-400 font-light mb-1`}
                >
                  {metric.value}
                </div>
                <div
                  className={`w-12 h-0.5 bg-gradient-to-r from-${metric.color}-500 to-transparent mx-auto mb-2`}
                ></div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-300 font-light leading-relaxed">
                  A passionate developer focused on building scalable full-stack
                  applications, robust backends, and modern web solutions. I
                  turn ideas into efficient, maintainable, and innovative code.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-1 gap-8 mb-28"
          variants={staggerContainerVariants}
          initial="hidden"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-white/10">
                    <span
                      className={`${colors.light} font-light text-sm ${
                        isLocked ? "opacity-50" : ""
                      }`}
                    >
                      {isLocked
                    ...
                    <motion.div
                      className={`flex items-center ${
                        colors.light
                      } font-light text-sm ${isLocked ? "opacity-50" : ""}`}
                      whileHover={{ x: 5 }}
                    >
        ...
        >
          <motion.div className="text-center mb-16" variants={fadeInUpVariants}>
            ...
            <p className="text-gray-400 text-lg font-light max-w-2xl mx-auto">
              Comprehensive skills across multiple domains of software
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300 text-lg font-light max-w-2xl mx-auto mb-8">
              Dive into any of my specialized realms to discover detailed
              projects, technical insights, and creative works in each domain.
            </p>
            <motion.button
